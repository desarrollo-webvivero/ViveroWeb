...
import { Phone, Mail, Clock, ChevronDown, CheckCircle2, AlertCircle, X } from 'lucide-react';
...
export default function ContactSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNotification({
        tipo: 'success',
        mensaje: '¡Mensaje enviado con éxito! Te hemos enviado un correo de confirmación.'
      });
      ...
      <div className="contact-container">
        ...
        <div className="contact-info">
          ...
          <div className="contact-details">
            ...
            <div className="detail-item">
              <Clock className="icon" size={20} strokeWidth={1.5} />
              <span>Lunes a Sábado: 8:00 AM - 5:00 PM</span>
            </div>
          </div>
        </div>
          ...
          {notification && (
            <div 
              style={{
                ...
                borderRadius: '8px',
                marginBottom: '20px',
                backgroundColor: notification.tipo === 'success' ? '#ECFDF5' : '#FEF2F2',
                border: `1px solid ${notification.tipo === 'success' ? '#A7F3D0' : '#FECACA'}`,
                color: notification.tipo === 'success' ? '#065F46' : '#991B1B',
                fontSize: '14px',
