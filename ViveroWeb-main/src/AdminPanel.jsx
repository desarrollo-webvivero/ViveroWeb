...
export default function AdminPanel() {
  ...
  e.preventDefault();
  try {
    // 1. Convertimos el precio a número antes de enviar
   // Objeto que debes enviar en tu petición axios/fetch al backend
const productoParaEnviar = {
  nombre: producto.nombre,
  precioBase: parseFloat(producto.precio), // "precioBase" en lugar de "precio"
  descripcion: producto.descripcion,
  imagenUrl: producto.imagenUrl,
  stockDisponible: 10, // O el campo de stock de tu formulario
  categoria: {
    id: producto.categoria === 'Interior' ? 1 : producto.categoria === 'Frutales' ? 2 : 3
  }
};
    // 2. Enviamos el objeto parseado
    await apiService.crearProducto(productoAEnviar);
