...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-vivero-cream text-vivero-dark font-sans antialiased selection:bg-vivero-green selection:text-white">
      ...
      {/* BARRA SUPERIOR: Se desmonta instantáneamente sin dejar rastros ni efectos de contracción */}
      {currentView === 'inicio' && (
      ...
      <header className="sticky top-0 z-50 bg-vivero-cream/95 backdrop-blur-md border-b border-vivero-green/20 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 sm:h-24">
            ...
            {/* CONDICIONAL: Menú completo vs Título "Contacto" + Botón de retorno */}
            {currentView === 'inicio' ? (
              <>
              ...
              <div className="flex items-center space-x-6">
                {/* Título de la página entre el logo y el botón */}
        ...
        {/* Menú móvil desplegable (Solo en inicio) */}
