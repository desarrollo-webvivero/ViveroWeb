...
export default function CatalogoFrutales() {
  ...
  const frutales = [
    { id: 4, nombre: 'Limón Mandarina', precio: 'Q120', img: 'https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?q=80&w=800&auto=format&fit=crop', desc: 'Cítrico resistente, ideal para macetas grandes o jardín directo.' },
    { id: 5, nombre: 'Aguacate Hass', precio: 'Q180', img: 'https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?q=80&w=800&auto=format&fit=crop', desc: 'Árbol injertado de rápido crecimiento y excelente producción.' },
    { id: 6, nombre: 'Naranjo Washington', precio: 'Q135', img: 'https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?q=80&w=800&auto=format&fit=crop', desc: 'Produce naranjas de ombligo dulces y sin semilla.' }
  ];
